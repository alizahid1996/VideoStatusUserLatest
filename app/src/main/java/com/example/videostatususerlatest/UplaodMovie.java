...
public class UplaodMovie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uplaod_movie);
    ...
    public void ShowVideo(View view) {
        ...
        Intent intent = new Intent(UplaodMovie.this, MainActivity.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(UplaodMovie.this, "Data saved", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(UplaodMovie.this, "Failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
